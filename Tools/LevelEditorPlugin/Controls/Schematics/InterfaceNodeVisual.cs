...
public class InterfaceNodeVisual : BaseNodeVisual
{
    ...
    public override SchematicsLayout.Node GenerateLayout()
    {
        ...
        {
            UniqueId = UniqueId,
            FileGuid = BlueprintGuid,
            InstanceGuid = instanceGuid,
            InterfaceData = new SchematicsLayout.InterfaceData() { NameHash = Self.NameHash, FieldType = FieldType, Direction = Direction },
            IsCollapsed = false,
        ...
        if (Self.ShortcutNode != null)
        {
            ...
            {
                UniqueId = Self.ShortcutNode.UniqueId,
                DisplayName = Self.ShortcutNode.ShortcutData.DisplayName,
                Position = Self.ShortcutNode.Rect.Location,
                ChildPositions = [],
                ChildGuids = []
            };
