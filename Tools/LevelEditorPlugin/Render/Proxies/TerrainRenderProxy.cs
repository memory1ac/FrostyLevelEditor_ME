...
public class TerrainRenderProxy : RenderProxy
{
    ...
    /// <summary>
    /// Exposes internal terrain chunk render data for terrain edit tools.
    /// </summary>
    public TerrainChunkRenderable RenderData => renderData;
    ...
    {
        // Simple hit test using current proxy world bounding box
        BoundingBox bbox = BoundingBox;
        if (hitTestRay.Intersects(ref bbox, out hitLocation))
        {
            return true;
        }
