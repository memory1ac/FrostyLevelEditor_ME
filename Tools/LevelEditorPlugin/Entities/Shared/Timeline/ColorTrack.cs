...
public class ColorTrack : PropertyTrackBase, IEntityData<FrostySdk.Ebx.ColorTrackData>
{
    ...
    public override void Update(float elapsedTime)
    {
        ...
        else
        {
            ...
            {
                x = SharpDX.MathUtil.Lerp(prevValue.x, nextValue.x, (elapsedTime - prevTime) / (nextTime - prevTime)),
                y = SharpDX.MathUtil.Lerp(prevValue.y, nextValue.y, (elapsedTime - prevTime) / (nextTime - prevTime)),
                z = SharpDX.MathUtil.Lerp(prevValue.z, nextValue.z, (elapsedTime - prevTime) / (nextTime - prevTime)),
                w = SharpDX.MathUtil.Lerp(prevValue.w, nextValue.w, (elapsedTime - prevTime) / (nextTime - prevTime))
            };
        }
