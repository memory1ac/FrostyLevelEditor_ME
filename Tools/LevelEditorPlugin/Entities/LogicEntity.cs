...
public class Property<T> : IProperty
{
    ...
    private List<IProperty> inConnections = [];
    private List<IProperty> outConnections = [];
...
public class Link<T> : ILink
{
    ...
    private List<ILink> inConnections = [];
    private List<ILink> outConnections = [];
...
public class Event<T> : IEvent
{
    ...
    private int nameHash;
    private string debugName;
    private List<IEvent> connections = [];
    private long setOnFrame;
