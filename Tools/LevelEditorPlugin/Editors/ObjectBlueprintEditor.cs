...
public class ObjectBlueprintEditor : SpatialEditor
{
    ...
    public override List<ToolbarItem> RegisterToolbarItems()
    {
        return
        [
            new DockingToolbarItem("", "Show/Hide components tab", "Images/Components.png",
                new RelayCommand((o) => DockManager.AddItem(((DockingToolbarItem)o).Location, new ComponentsViewModel(this))), DockManager, "UID_LevelEditor_Components"),
            new DockingToolbarItem("", "Show/Hide properties tab", "Images/Properties.png",
                new RelayCommand((o) => DockManager.AddItem(((DockingToolbarItem)o).Location, new PropertiesViewModel(this, selectedEntity))), DockManager, "UID_LevelEditor_Properties"),
            new FloatingOnlyDockingToolbarItem("", "Show/Hide schematics editor", "Images/Schematics.png",
                new RelayCommand((o) => DockManager.AddItem(((DockingToolbarItem)o).Location, new SchematicsViewModel(this, rootLayer))), DockManager, "UID_LevelEditor_Schematics"),
