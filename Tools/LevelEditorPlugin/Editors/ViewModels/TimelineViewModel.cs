...
public class IconCache
{
    ...
    private Dictionary<string, ImageSource> icons = [];
...
public class TrackDataWrapper : INotifyPropertyChanged
{
    ...
    private List<TrackDataWrapper> dataTracks = [];
    private bool isSelected;
    private bool isExpanded;
...
public class TimelineViewModel : IDockableItem, INotifyPropertyChanged
{
    ...
    private void SetLayer(Layers.SceneLayer layer)
    {
        ...
        List<Entities.TimelineEntity> timelines = [.. entities.Select(e => e as Entities.TimelineEntity)];
    ...
    private void ChangeTimeline(Entities.TimelineEntity newTimeline)
    {
        ...
        if (newTimeline != null)
        {
            ...
            List<TrackWrapper> newTracks = [];
            List<TrackDataWrapper> newDataTracks = [];
