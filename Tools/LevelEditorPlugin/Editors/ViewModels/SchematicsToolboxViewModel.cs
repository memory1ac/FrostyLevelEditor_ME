...
public class ToolboxFolderItem : INotifyPropertyChanged
{
    ...
    private string m_name;
    private List<ToolboxTypeItem> m_children = [];
    private bool m_isExpanded;
    private bool m_isSelected;
...
public class SchematicsToolboxViewModel : Controls.IDockableItem, INotifyPropertyChanged, IDragDropSourceProvider
{
    ...
    public SchematicsToolboxViewModel()
    {
        ...
        List<Type> types = [.. Assembly.GetExecutingAssembly().GetTypes().Where(t => IsTypeValid(t))];
        m_allTypes = types;
    ...
    {
        List<ToolboxFolderItem> modules = [];
...
public class LevelEditorToolboxViewModel : Controls.IDockableItem, INotifyPropertyChanged, IDragDropSourceProvider
{
    public string Header => "Toolbox";
    public virtual string UniqueId => "UID_LevelEditor_Toolbox";
    public string Icon => "Images/Toolbox.png";
    ...
    public LevelEditorToolboxViewModel()
    {
        m_filterText = "";
