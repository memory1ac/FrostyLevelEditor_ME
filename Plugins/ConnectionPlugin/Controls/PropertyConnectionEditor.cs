    ...
    public class PropertyConnectionControl : Control
    {
        ...
        protected virtual void RefreshUI()
        {
            ...
            try
            {
                ...
                // 2025/11/27
                // 改动标记
                GetRealmTextSuper(propConnection.Flags, realmTextBox);
        ...
        /// 改动标记
        /// </summary>
        protected void GetRealmTextSuper(dynamic flags, TextBlock textBlock)
        {
            textBlock.Inlines.Clear();

            var realm = (uint)(flags & 7);
            var propType = (uint)((flags & 48) >> 4);
            var sourceCantBeStatic = (flags & 8) != 0;
            ...
            // 分隔符
            textBlock.Inlines.Add(new Run(" - ") { Foreground = Brushes.SlateGray });

            switch (propType)
            {
                case 0: // Default
                    textBlock.Inlines.Add(new Run("D") { Foreground = Brushes.DodgerBlue });
                    textBlock.Inlines.Add(new Run(".") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run("I") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run(".") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run("E") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run(".") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run("I") { Foreground = Brushes.SlateGray });
                    break;
                case 1: // Interface
                    textBlock.Inlines.Add(new Run("D") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run(".") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run("I") { Foreground = Brushes.DodgerBlue });
                    textBlock.Inlines.Add(new Run(".") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run("E") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run(".") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run("I") { Foreground = Brushes.SlateGray });
                ...
                case 2: // Exposed
                    ...
                    textBlock.Inlines.Add(new Run("I") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run(".") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run("E") { Foreground = Brushes.DodgerBlue });
                    textBlock.Inlines.Add(new Run(".") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run("I") { Foreground = Brushes.SlateGray });
                    break;
                case 3: // Invalid
                    ...
                    break;
                default: // unknown
                    textBlock.Inlines.Add(new Run("D") { Foreground = Brushes.Red });
                    textBlock.Inlines.Add(new Run(".") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run("I") { Foreground = Brushes.Red });
                    textBlock.Inlines.Add(new Run(".") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run("E") { Foreground = Brushes.Red });
                    textBlock.Inlines.Add(new Run(".") { Foreground = Brushes.SlateGray });
                    textBlock.Inlines.Add(new Run("I") { Foreground = Brushes.Red });
                    break;
            }
            ...
            if (sourceCantBeStatic)
                textBlock.Inlines.Add(new Run("1") { Foreground = Brushes.HotPink });
            else
                textBlock.Inlines.Add(new Run("0") { Foreground = Brushes.SlateGray });
        }
